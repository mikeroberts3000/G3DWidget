...
G3DWidget is a Qt Widget that can host 3D rendering code from the G3D Innovation Engine. The G3DWidget class has been carefully designed so that multiple G3DWidget objects can co-exist in the same application. Demo application included.
